...
export const Component = () => {
  ...
  return (
      <div className="bg-black">
          <div
              className='min-h-screen text-white w-screen bg-black flex flex-col items-center justify-center'>
            <h1 className='text-8xl  max-w- text-center elsie-black'>Features Section</h1>
            <p className='mt-1 flex items-center gap-1.5 text-sm'></p>
          </div>
          {/* <ScrollSection /> */}
